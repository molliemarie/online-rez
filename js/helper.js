...
var HTMLskillsChart= '<img src="%data%" class="skillsChart">';
...
var HTMLprofessionalDevelopment = '<h3>Professional Development</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<br><a class="URL-text" href="#">%data%</a>';
